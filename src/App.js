...
class App extends Component {
  ...
  calcular = () => {
    ...
    //  A QUI SE CAMBIAN LOS PORCENTAJES
    if (this.state.sueldo > 0 && this.state.sueldo !== undefined) {
      ...
      aniosantig = (RestaFechas).toFixed(0);
    ...
    console.log('años de antigüedad' + this.state.aniosantig);
        ...
        <>
          ...
          <div className="center">
            ...
            <div id="sidebar" className="archivosAdminCenter3">
              ...
              <br/>
              <output> Años de antigüedad: {this.state.aniosantig}</output>
              <br/>
